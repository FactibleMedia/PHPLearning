...
<body>
    ...
    <?php
        ...
        if (isset($_COOKIE["username"])) {
            ...
            echo "<p>Hola " . $_COOKIE["username"] . "</p>";
            
        } elseif ($authentication == true) {
            
            echo "<p>Hola " . $_POST["user"] . "</p>";
    ...
    <?php
        ...
        if($authentication == true || isset($_COOKIE["username"])) {
            
            include("registeredzone.html");
